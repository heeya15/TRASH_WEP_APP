...
<div id="page-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
						...
						<body>
						    <form method="post" action="/page/mypage/garbage_modify_process.php" enctype="multipart/form-data">
						    	...
						    	<div style="text-align: center; margin-top:20px;">
						    		...
						    		<a href="/page/mypage/garbage_upload_list.php" class="btn btn-default">목록</a>
						    	</div>
						    </form>
						<br/>
				</div>
